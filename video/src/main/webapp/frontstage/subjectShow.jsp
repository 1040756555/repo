                 ...
                 <div class="section">
                      ...
                      <ul>            
             		      <li class="section-main" onclick="getVideo(217)">
		             		  <div class="thum" style="background-image: url(${pageContext.request.contextPath}/videoimg/25.jpg)"></div>
                 ...
                 <div class="section">
                      ...
                      <ul>         
	             		<li class="section-main" onclick="getVideo(245)">
	             		    <div class="thum" style="background-image: url(${pageContext.request.contextPath}/speakerimg/3.jpg)"></div>
            ...
            <div class="container" id="dataContainer">
                 <div class="section">
                      ...
                      <div class="kcIntro">
	                      <p class="int">
	                         <span>课程介绍：</span>
	                                                                 适合有一定HTML+JS基础、想学习React的同学。
	                                                                 本课程循序渐进、浅显易懂，非常适合React入门学习。想进一步学习和使用React进行开发的同学可以报名智游前端开发课程。
	                      </p>
                      </div>
                      <ul>           
