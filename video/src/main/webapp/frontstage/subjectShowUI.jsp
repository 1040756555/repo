    ...
    <div id="app">
            ...
            <div class="container" id="dataContainer">
                 <div class="section">
                      ...
                      <div class="kcIntro">
                           <p class="int">
                           <span>课程介绍：</span>
                                                                      适合无编程基础但想学UI开发的同学入门学习，也适合HTML、Java、PHP等其他学科学员预习或练习。
                      ...
                      <ul>            
             		      <li class="section-main" onclick="getVideo(217)">
		             		  <div class="thum" style="background-image: url(${pageContext.request.contextPath}/videoimg/17.jpg)"></div>
		             		  <p><a href="${pageContext.request.contextPath}/frontstage/videoPlay.jsp">前端开发环境搭建</a></p>
     ...
     <div class="classify">
            <div class="container" id="dataContainer">
                 <div class="section">
                      <div class="classifyName">
                           <p class="title title-first">UI与Git入门</p>
                      </div>
                      <div class="kcIntro">
        ...
        <div class="classify">
            <div class="container" id="dataContainer">
                 <div class="section">
                      <div class="classifyName">
                           <p class="title title-first">每天20分钟轻松入门UI</p>
                      </div>
                      <div class="kcIntro">
	                      <p class="int">
	                         <span>课程介绍：</span>
	                                                                 适合有一定UI基础、想学习UI的同学。
	                                                                 本课程循序渐进、浅显易懂，非常适合UI入门学习。想进一步学习和使用UI进行开发的同学可以报名智游前端开发课程。
	                      </p>
                      </div>
                      <ul>           
	             		<li class="section-main" onclick="getVideo(224)">
		             		<div class="thum" style="background-image: url(${pageContext.request.contextPath}/videoimg/17.jpg)"></div>
		             		<p><a href="${pageContext.request.contextPath}/frontstage/videoPlay.jsp">UI快速体验-组件</a></p>
		             		<div class="classify-v-info">
		             		<span class="count" title="观看次数">
