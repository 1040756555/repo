...
<header>
    ...
    <div id="app">
        ...
        <!--面包屑导航-->
        <div class="container mian-nav" id="navDiv">公开课 / JAVA前端</div>
            ...
            <div class="container" id="dataContainer">
                 <div class="section">
                      <div class="classifyName">
                           <p class="title title-first">JAVA入门小项目</p>
                      </div>
                      <div class="kcIntro">
                           <p class="int">
                           <span>课程介绍：</span>
                      ...
                      <ul>            
             		      <li class="section-main" onclick="getVideo(217)">
		             		  <div class="thum" style="background-image: url(${pageContext.request.contextPath}/speakerimg/5.jpg"></div>
		             		  <p><a href="${pageContext.request.contextPath}/frontstage/videoPlay.jsp">java开发环境搭建</a></p>
     ...
     <div class="classify">
            <div class="container" id="dataContainer">
                 <div class="section">
                      <div class="classifyName">
                           <p class="title title-first">Java入门</p>
                      </div>
                      <div class="kcIntro">
		                      <p class="int"><span>java课程介绍：</span>
		                      JAVA是真牛逼,谁用谁知道;
		                      </p>
                      </div>
                      <ul>         
	             		<li class="section-main" onclick="getVideo(245)">
	             		    <div class="thum" style="background-image: url(${pageContext.request.contextPath}/speakerimg/5.jpg)"></div>
	             		    <p><a href="${pageContext.request.contextPath}/frontstage/videoPlay.jsp">论java的牛逼程度</a></p>
	             		    <div class="classify-v-info">
	             		         <span class="count" title="观看次数">
        ...
        <div class="classify">
            <div class="container" id="dataContainer">
                 <div class="section">
                      <div class="classifyName">
                           <p class="title title-first">每天20分钟轻松入门java</p>
                      </div>
                      <div class="kcIntro">
	                      <p class="int">
	                         <span>课程介绍：</span>
	                            java拍案而起,指着在座的,大声说道:"我不是针对你们某个人,我只想说在座的都是垃圾"                                  
	                      </p>
                      </div>
                      <ul>           
	             		<li class="section-main" onclick="getVideo(224)">
		             		<div class="thum" style="background-image: url(${pageContext.request.contextPath}/speakerimg/5.jpg)"></div>
		             		<p><a href="${pageContext.request.contextPath}/frontstage/videoPlay.jsp">java拍案而起</a></p>
		             		<div class="classify-v-info">
		             		<span class="count" title="观看次数">
