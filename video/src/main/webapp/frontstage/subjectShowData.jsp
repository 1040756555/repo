    ...
    <div id="app">
            ...
            <div class="container" id="dataContainer">
                 <div class="section">
                      <div class="classifyName">
                           <p class="title title-first">大数据入门小项目</p>
                      </div>
                      <div class="kcIntro">
                           <p class="int">
                           <span>课程介绍：</span>
                      ...
                      <ul>            
             		      <li class="section-main" onclick="getVideo(217)">
		             		  <div class="thum" style="background-image: url(${pageContext.request.contextPath}/speakerimg/4.jpg)"></div>
		             		  <p><a href="${pageContext.request.contextPath}/frontstage/videoPlay.jsp">大数据开发环境搭建</a></p>
     ...
     <div class="classify">
            <div class="container" id="dataContainer">
                 <div class="section">
                      <div class="classifyName">
                           <p class="title title-first">大数据开发与Git入门</p>
                      </div>
                      <div class="kcIntro">
                      ...
                      <ul>         
	             		<li class="section-main" onclick="getVideo(245)">
	             		    <div class="thum" style="background-image: url(${pageContext.request.contextPath}/speakerimg/4.jpg)"></div>
	             		    <p><a href="${pageContext.request.contextPath}/frontstage/videoPlay.jsp">大数据的悲惨生活</a></p>
	             		    <div class="classify-v-info">
	             		         <span class="count" title="观看次数">
        ...
        <div class="classify">
            <div class="container" id="dataContainer">
                 <div class="section">
                      <div class="classifyName">
                           <p class="title title-first">每天20分钟轻松入门大数据</p>
                      </div>
                      <div class="kcIntro">
	                      <p class="int">
	                         <span>课程介绍：</span>
                      ...
                      <ul>           
	             		<li class="section-main" onclick="getVideo(224)">
		             		<div class="thum" style="background-image: url(${pageContext.request.contextPath}/speakerimg/4.jpg)"></div>
		             		<p><a href="${pageContext.request.contextPath}/frontstage/videoPlay.jsp">大数据的吹牛逼生活</a></p>
		             		<div class="classify-v-info">
		             		<span class="count" title="观看次数">
