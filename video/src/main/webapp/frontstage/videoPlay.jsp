...
<link rel="icon" href="http://localhost:8080/Voids/static/z/favicon.png" type="image/png">
    <link href="${pageContext.request.contextPath}/A/video-js.css" rel="stylesheet" type="text/css">
...
<div class="intro">
	<div class="container">
		<div class="v-intro">
			<div class="left">
				<video id="videoPlayer" src="${pageContext.request.contextPath}/mp/1.mp4" class="video-js vjs-default-skin" controls="controls" poster="static/z/02.jpg" data-setup="{}" height="280" width="627">
				</video>
			</div>
