...
<header>
    ...
    <div id="app">
        ...
        <!--面包屑导航-->
        <div class="container mian-nav" id="navDiv">公开课 /Python</div>
            ...
            <div class="container" id="dataContainer">
                 <div class="section">
                      <div class="classifyName">
                           <p class="title title-first">UI入门小项目</p>
                      </div>
                      <div class="kcIntro">
                           <p class="int">
                           <span>课程介绍：</span>
                                                                      适合无编程基础但想学Python前端开发的同学入门学习，预习或练习。
                      ...
                      <ul>            
             		      <li class="section-main" onclick="getVideo(217)">
		             		  ...
		             		  <p><a href="${pageContext.request.contextPath}/frontstage/videoPlay.jsp">Python开发环境搭建</a></p>
     ...
     <div class="classify">
                 ...
                 <div class="section">
                      ...
                      <ul>         
	             		<li class="section-main" onclick="getVideo(245)">
	             		    <div class="thum" style="background-image: url(${pageContext.request.contextPath}/videoimg/18.jpg)"></div>
        ...
        <div class="classify">
            <div class="container" id="dataContainer">
                 <div class="section">
                      <div class="classifyName">
                           <p class="title title-first">每天20分钟轻松入门Python</p>
                      </div>
                      <div class="kcIntro">
	                      <p class="int">
	                         <span>课程介绍：</span>
	                                                                 适合有一定Python基础、想学习Python的同学。
	                                                                 本课程循序渐进、浅显易懂，非常适合Python入门学习。想进一步学习和使用Python进行开发的同学可以报名智游Python开发课程。
	                      </p>
                      </div>
                      <ul>           
	             		<li class="section-main" onclick="getVideo(224)">
		             		<div class="thum" style="background-image: url(${pageContext.request.contextPath}/videoimg/18.jpg)"></div>
		             		<p><a href="${pageContext.request.contextPath}/frontstage/videoPlay.jsp">React快速体验-组件</a></p>
		             		<div class="classify-v-info">
		             		<span class="count" title="观看次数">
