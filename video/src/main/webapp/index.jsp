...
<link rel="stylesheet" href="A/css.css">
<link rel="icon" href="http://localhost:8080/z/favicon.png" type="image/png">
...
<header>
	<div class="container">
		...
		<a onclick="JavaScript:addFavorite2()">
		   <img src="${pageContext.request.contextPath}/z/sc.png" draggable="false">加入收藏
		</a>		
		<a target="_blank" href="${pageContext.request.contextPath}/login.jsp">
		   <img src="${pageContext.request.contextPath}/z/we.png" draggable="false">后台管理
		</a>
	...
	<img alt="" src="${pageContext.request.contextPath}/z/banner-2.jpg">
	</div>
        ...
        <div class="container">
            ...
            <div class="course-info">
                <table cellspacing="10">
                    <tbody><tr>
                        <td colspan="2">
                            <a href="${pageContext.request.contextPath}/frontstage/subjectShow.jsp">
                                <img src="${pageContext.request.contextPath}/z/html5.jpg" alt="" class="image scale" draggable="false">
                                <div class="headline">
                                    <span>Web前端教程</span>
                                    <img src="${pageContext.request.contextPath}/z/arrow.png" alt="">
                                </div>
                            </a>
                        </td>
                        <td>
                            <!--上线时修改id-->
                            <a href="${pageContext.request.contextPath}/frontstage/subjectShowUI.jsp">
                                <img src="${pageContext.request.contextPath}/z/ui.jpg" alt="" class="image scale" draggable="false">
                                <div class="headline">
                                    <span>UI设计教程</span>
                                    <img src="${pageContext.request.contextPath}/z/arrow.png" alt="">
                                </div>
                        ...
                        <td rowspan="2" class="one_three">
                            <a class="opacity5" href="${pageContext.request.contextPath}/frontstage/subjectShowJava.jsp">
                                <img src="${pageContext.request.contextPath}/z/java.jpg" alt="" class="image scale" draggable="false">
                                <div class="headline">
                                    <span>Java教程</span>
                                    <img src="${pageContext.request.contextPath}/z/arrow.png" alt="">
                                </div>
                    ...
                    <tr>
                        <td>
                            <a  class="opacity5" href="${pageContext.request.contextPath}/frontstage/subjectShowData.jsp">
                                <img src="${pageContext.request.contextPath}/z/bigdata.jpg" alt="" class="image" draggable="false">
                                <div class="headline">
                                    <span>大数据教程</span>
                                    <img src="${pageContext.request.contextPath}/z/arrow.png" alt="">
                                </div>
                        ...
                        <td colspan="2">
                            <a class="opacity5" href="${pageContext.request.contextPath}/frontstage/subjectShowPython.jsp">
                                <img src="${pageContext.request.contextPath}/z/python.jpg" alt="" class="image scale" draggable="false">
                                <div class="headline">
                                    <span>Python教程</span>
                                    <img src="${pageContext.request.contextPath}/z/arrow.png" alt="">
                                </div>
                    ...
                    <tr>
                        <td colspan="2">
                            <a class="opacity5" href="${pageContext.request.contextPath}/frontstage/subjectShowPhp.jsp">
                                <img src="${pageContext.request.contextPath}/z/php.jpg" alt="" class="image scale" draggable="false">
                                <div class="headline">
                                    <span>PHP教程</span>
                                    <img src="${pageContext.request.contextPath}/z/arrow.png" alt="">
                                </div>
                        ...
                        <td colspan="2" class="three_two">
                            <img src="${pageContext.request.contextPath}/z/qidai.jpg" alt="" class="image" draggable="false">
                            <div class="headline">
                                更多课程，敬请期待...
                            </div>
                        </td>
    ...
    <div class="form_area">
        <div class="container">
            ...
            <form id="iform" action="addEmp"  method="get">
